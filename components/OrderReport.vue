    ...
    <div class="p-6 bg-gray-900 rounded-lg">
        <div class="flex justify-between items-center pb-4">
            ...
            <button class="flex py-3 px-4 rounded-lg border border-gray-700 gap-x-2.5">
                <Icon name="gg:options" size="20" class="text-white"/>
                ...
                <tr v-for="order in orders" class="text-sm text-gray-500">
                    <td class="py-4">
                        <div class="flex gap-4 items-center">
                            <!-- <img width="32" :src="`~/assets/images/avatars/${order.avatar}`" alt="image" /> -->
                            <img width="32" src="~/assets/images/avatars/avatar-1.png" alt="image" />
                    ...
                    <td class="py-4 flex justify-center">
                        <span class="flex justify-center py-1 w-24 font-medium capitalize rounded-full" :class="{
